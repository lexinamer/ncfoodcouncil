<?php
/**
 * NCFoodCouncil functions and definitions
 *
...
if ( ! function_exists( 'nclfc_setup' ) ) :
	function nclfc_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'nclfc_custom_background_args', array(
...
add_action( 'after_setup_theme', 'nclfc_setup' );
 ...
 */
function nclfc_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'nclfc_content_width', 640 );
}
add_action( 'after_setup_theme', 'nclfc_content_width', 0 );
...
add_action( 'widgets_init', 'nclfc_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function nclfc_scripts() {
	wp_enqueue_style( 'nclfc-style', get_stylesheet_uri() );

	wp_enqueue_script( 'nclfc-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
